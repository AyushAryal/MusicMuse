...
from ..melolib.chord2vec import chord2vec
from ..melolib.chord_progression_parser import chord_progression_parser
from ..melolib.music import Chord
...
def main():
    default_input_path = (
        Path(__file__).parent.parent.parent / "out/all_chord_progressions.json"
    )
    default_output_path = Path(__file__).parent.parent.parent / "out/chord_vectors.bin"
